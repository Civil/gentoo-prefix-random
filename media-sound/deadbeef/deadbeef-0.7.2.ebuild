...
SLOT="0"
IUSE="+aac aqua adplug alac +alsa +artwork +cdda +curl dts dumb ffmpeg +flac gme gtk 
...
src_prepare() {
	cp "${FILESDIR}/retina.h" ${S}/plugins/gtkui/ || die "Failed to copy retina.h"
	default
}
